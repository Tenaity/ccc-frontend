...
interface StaffStatsProps {
  totalStaff: number
  canNightCount: number
  averageQuota: number
}

export function StaffStats({ totalStaff, canNightCount, averageQuota }: StaffStatsProps) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      ...
      <GlassPanel variant="strong" className="p-6">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-sm font-medium text-muted-foreground">Can Work Night Shift</p>
      ...
      <GlassPanel variant="strong" className="p-6">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-sm font-medium text-muted-foreground">Average Quota</p>
